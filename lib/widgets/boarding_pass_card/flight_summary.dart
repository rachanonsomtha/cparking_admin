...
class FlightSummary extends StatelessWidget {
  ...
  Widget _buildTicketDuration() {
    ...
    if (theme == SummaryTheme.light)
      planeRoutePath = 'assets/images/boarding_pass_card/planeroute_blue.png';
    if (theme == SummaryTheme.dark)
      planeRoutePath = 'assets/images/boarding_pass_card/planeroute_white.png';
          ...
          Container(
            ...
            child: Stack(
              ...
              children: <Widget>[
                ...
                if (theme == SummaryTheme.light)
                  Image.asset(
                      'assets/images/boarding_pass_card/airplane_blue.png',
                      height: 20,
                      fit: BoxFit.contain,
                      package: App.pkg),
                if (theme == SummaryTheme.dark)
                  _AnimatedSlideToRight(
                    child: Image.asset(
                        'assets/images/boarding_pass_card/airplane_white.png',
                        height: 20,
                        fit: BoxFit.contain,
                        package: App.pkg),
                    isOpen: isOpen,
